...
<div align="center">
	...
	<table style="width:600px; margin:0px;padding:0px; align-self: center;">
		<tr style="height: 30px">
			<td align="left" style="width: 50%">
				<!-- Total 99 articles , 20 pages / Now page is 12 -->
	...
	<table style="width: 600px; margin: 1px; padding:3px; background-color: #FFFFFF; align-self: center;">
		...
		<c:forEach var="dto" items="${lists }">
			...
			<c:if test="${n!=0 && n%3==0 }">
				...
				<td style="width:200px;" align="center">
					<img src="${imagePath }/${dto.saveFileName}" style="width: 180px;height:180px;  alt="" />
					<br /><br />
			...
			<tr align="center" style="height:30px">
				<td colspan="3">
					...
					<form action="" name="searchForm" method="post">
						<select name="searchKey" class="selectedField" id="" style="height:22px">
		...
		<!-- imageBoard 테이블에 데이터가 존재 하지 않을 경우 -->
