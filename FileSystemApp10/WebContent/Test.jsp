...
<div>
   ...
   <p class="notice">
      ...
      <span style="color: red;">파일 갯수 입력 후</span>
       확인 버튼을 눌러주세요<br>
      입력이 완료되면 <span style="color: red;">파일 업로드</span>
      버튼을 눌러주세요.
   </p>
   <hr />
</div>
   ...
   <form name="frmName1" method="post">
      <table class="tbl">
         ...
         <tr>
            ...
            <td colspan="3" style="width: 50%;"><textarea name="content" id="" cols="40" rows=""  style="width : 98%;"
            onkeyup="inputValue(this.form, content, frmName2, 2)"><%=getParam(request, "content") %></textarea>
            </td>
   ...
   <form action="" name="frmName2" method="post" enctype="multipart/form-data">
      <table class="tbl">
         <tr>
            ...
            <td>
               <input type="button" value="파일 업로드" onclick="elementCheck(this.form)"/>
            </td>
         </tr>
      </table>
